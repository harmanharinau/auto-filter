...
from utils import get_size, is_subscribed, save_group_settings, temp
...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        ...
        await asyncio.sleep(2) # 😢 https://github.com/Aadhi-Xr/Ajax-Extra-Features/blob/master/plugins/p_ttishow.py#L17 😬 wait a bit, before checking.
